...
<div class="row">
	<div class="col-md-6 mt-5">
		...
		<form class="needs-validation" method="post" action="{{ route('admin.admin.reset.password', [$id]) }}" novalidate>
			{{ csrf_field() }}
			<div class="form-group">
				<label for="username">Username</label>
				<input type="text" name="username" id="username" placeholder="Username" class="form-control" value="{{ $admin->username }}" readonly>
			</div>
			<div class="form-group">
 	...
 	// generate password
  	$('#generate_password').on('click', function() {
  		$.ajax({
  			...
  			type: 'post',
  			url: '/admin/admin/generate-password',
  			data: null,
  			dataType: 'json',
