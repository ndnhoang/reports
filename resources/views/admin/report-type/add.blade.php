...
<div class="row">
	<div class="col-md-6 mt-5">
		...
		<form class="needs-validation" method="post" action="{{ route('admin.report.type.add') }}" novalidate>
			{{ csrf_field() }}
			<div class="form-group">
				<label for="type_name">Type Name</label>
				<input type="text" name="type_name" id="type_name" placeholder="Type Name" class="form-control" value="{{ old('type_name') }}" required>
